export default {
  ...
  router: {
    ...
    pocManagement: 'POC Management',
    fingerprintManagement: 'Fingerprint Management',
    sensitiveInformationRules: 'Sensitive Information Rules',
    dictionaryManagement: 'Dictionary Management',
    subdomainDictionary: 'Subdomain Dictionary',
  ...
  project: {
    ...
    msgScheduledTasks:
      'Regularly obtain subdomain names of the root domain name and remove duplicates.',
