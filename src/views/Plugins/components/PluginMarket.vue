...
import { ElDrawer, ElRow, ElCol, ElInput, ElSelect, ElOption, ElCard, ElTag } from 'element-plus'
...
interface PluginMarketProps {
  ...
  onClose: () => void
  onRefresh: () => void
  onInstall: (plugin: RemotePluginData) => Promise<void>
}
            ...
            >
              ...
              <div class="plugin-card-content">
                ...
                <div class="plugin-actions" @click.stop>
                  ...
                  <BaseButton v-else type="primary" style="width: 100%" @click="onInstall(plugin)">
                    {{ t('plugin.install') }}
                  </BaseButton>
                </div>
              </div>
